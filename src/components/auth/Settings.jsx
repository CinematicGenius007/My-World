        ...
        <div className="w-full">
            {
                !user
                    ?
                    <h2 className="px-12 md:px-16 lg:px-20 text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-zinc-800 transition-[font-size] duration-1000">first login to witness the miracles that we created and how did you access this page without logging in anyway.</h2>
                    :
                    <>
